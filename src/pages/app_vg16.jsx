...
const App_vg16 = () => {
  ...
  useEffect(() => {
    const fetchAllHomes = async () => {
      try {
        const res = await axios.get('https://backend-code-0wjy.onrender.com/vg16');
        setHome(res.data);
      } catch (err) {
        console.error(err);
      }
  ...
  useEffect(() => {
    if (home.length > 0) {
      ...
      const keyword = '@keras_export("keras.applications.vgg16.VGG16", "keras.applications.VGG16")';
  ...
  return (
    <div className="codemirror-container">
      ...
      <div className="editor-container">
        <h1>applications.vgg16.VGG16</h1>
        <CodeMirror
          value={code}
